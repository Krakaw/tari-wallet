 ...
 * @returns {string}
 */
export function derive_public_key_hex(master_key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(master_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.derive_public_key_hex(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {WasmScanner}
 */
export function create_wasm_scanner(data) {
    const ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.create_wasm_scanner(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return WasmScanner.__wrap(ret[0]);
}
 ...
 */
export function initialize_http_scanner(scanner, base_url) {
    _assertClass(scanner, WasmScanner);
    const ptr0 = passStringToWasm0(base_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.initialize_http_scanner(scanner.__wbg_ptr, ptr0, len0);
    return ret;
}
 ...
 */
export function process_http_blocks_async(scanner, http_response_json, base_url) {
    _assertClass(scanner, WasmScanner);
    ...
    const ret = wasm.process_http_blocks_async(scanner.__wbg_ptr, ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {string}
 */
export function scan_block_data(scanner, block_data_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        _assertClass(scanner, WasmScanner);
        const ptr0 = passStringToWasm0(block_data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.scan_block_data(scanner.__wbg_ptr, ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function scan_single_block(scanner, block_data_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        _assertClass(scanner, WasmScanner);
        const ptr0 = passStringToWasm0(block_data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.scan_single_block(scanner.__wbg_ptr, ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function get_scanner_stats(scanner) {
    let deferred2_0;
    let deferred2_1;
    try {
        _assertClass(scanner, WasmScanner);
        const ret = wasm.get_scanner_stats(scanner.__wbg_ptr);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function get_scanner_state(scanner) {
    let deferred1_0;
    let deferred1_1;
    try {
        _assertClass(scanner, WasmScanner);
        const ret = wasm.get_scanner_state(scanner.__wbg_ptr);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @param {WasmScanner} scanner
 */
export function reset_scanner(scanner) {
    _assertClass(scanner, WasmScanner);
    wasm.reset_scanner(scanner.__wbg_ptr);
}
 ...
 * @returns {Promise<string>}
 */
export function get_tip_info(scanner) {
    _assertClass(scanner, WasmScanner);
    const ret = wasm.get_tip_info(scanner.__wbg_ptr);
    return ret;
}
 ...
 * @returns {Promise<string>}
 */
export function fetch_blocks_by_heights(scanner, heights_json) {
    _assertClass(scanner, WasmScanner);
    const ptr0 = passStringToWasm0(heights_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fetch_blocks_by_heights(scanner.__wbg_ptr, ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<string>}
 */
export function search_utxos(scanner, commitments_json) {
    _assertClass(scanner, WasmScanner);
    const ptr0 = passStringToWasm0(commitments_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.search_utxos(scanner.__wbg_ptr, ptr0, len0);
    return ret;
}
 ...
 * @returns {string}
 */
export function create_scan_config(scanner, start_height, end_height) {
    let deferred2_0;
    let deferred2_1;
    try {
        _assertClass(scanner, WasmScanner);
        const ret = wasm.create_scan_config(scanner.__wbg_ptr, start_height, !isLikeNone(end_height), isLikeNone(end_height) ? BigInt(0) : end_height);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
...
export class WasmScanner {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmScanner.prototype);
        obj.__wbg_ptr = ptr;
        WasmScannerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper594 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 122, __wbg_adapter_46);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('lightweight_wallet_libs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
